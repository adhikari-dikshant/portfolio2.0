                ...
                <div className="menu-content">
                    ...
                    >
                        <div className="menu-content-group">
                            <p >&copy; dikshant singh adhikari</p>
                            <p>TechMeraki</p>
                            <p>Udaipur</p>
                        </div>

                        <div className="menu-content-group">
                            <p className="sm">Edition</p>
                            <p>2026 Version 2.0</p>
                        </div>

                        <div className="menu-content-group">
                            <p className="sm">Say Hello</p>
                            <p>
                                <a href="mailto:dikshantsadhikari03@gmail.com">
                        ...
                        <div className="menu-content-group">
                            <p className="sm">Hotline</p>
                            <p>
                                <a href="tel:+919352198881">
                                    +91 93521 98881
                                </a>
                            </p>
                        </div>
                    ...
                    >
                        <div className="menu-content-group">
                            <p className="sm">Field Log</p>

                            <a href="https://x.com/ikshwaku03" target="_blank">
                                Twitter (X)
                            </a>

                            <a href="https://www.instagram.com/ikshwaku_/" target="_blank">
                                Instagram
                            </a>

                            <a href="https://www.linkedin.com/in/dikshant-singh-adhikari/" target="_blank">
                                Linkedin
                            </a>
                        </div>

                        <div className="menu-content-group">
                            <p className="sm">Language</p>
                            <p>Human</p>
                            <p>English</p>
                            <p>Hindi</p>
                        </div>
