            ...
            <div className="marquees">
                <div className="marquee-container" id="marquee-1">
                    <div className="marquee">
                        ...
                        <div className="marquee-img-item">
                            <img src="/spotlight/spotlight-2.webp" alt="" />
                        </div>
                        <div className="marquee-img-item">
                            <img src="/spotlight/spotlight-3.webp" alt="" />
                        </div>
                        <div className="marquee-img-item">
                            <img src="/spotlight/spotlight-4.webp" alt="" />
                        </div>
                    </div>
                </div>
                ...
                <div className="marquee-container" id="marquee-2">
                    <div className="marquee">
                        ...
                        <div className="marquee-img-item">
                            <img src="/spotlight/spotlight-6.webp" alt="" />
                        </div>
                        <div className="marquee-img-item">
                            <img src="/spotlight/spotlight-7.webp" alt="" />
                        </div>
                        <div className="marquee-img-item marquee-text-item">
                            <h1>Fragmented</h1>
                        </div>
                ...
                <div className="marquee-container" id="marquee-3">
                    <div className="marquee">
                        <div className="marquee-img-item">
                            <img src="/spotlight/spotlight-9.webp" alt="" />
                        </div>
                        <div className="marquee-img-item marquee-text-item">
                            <h1>Softcore</h1>
                        </div>
                        ...
                        <div className="marquee-img-item">
                            <img src="/spotlight/spotlight-11.webp" alt="" />
                        </div>
                        <div className="marquee-img-item">
                            <img src="/spotlight/spotlight-12.webp" alt="" />
                        </div>
                    </div>
                </div>
                ...
                <div className="marquee-container" id="marquee-4">
                    <div className="marquee">
                        <div className="marquee-img-item">
                            <img src="/spotlight/spotlight-13.webp" alt="" />
                        </div>
                        <div className="marquee-img-item">
                            <img src="/spotlight/spotlight-14.webp" alt="" />
                        </div>
                        <div className="marquee-img-item">
                            <img src="/spotlight/spotlight-15.webp" alt="" />
                        </div>
                        <div className="marquee-img-item marquee-text-item">
                            <h1>Motion</h1>
                        </div>
                        <div className="marquee-img-item">
                            <img src="/spotlight/spotlight-16.webp" alt="" />
                        </div>
                    </div>
                </div>
            </div>
