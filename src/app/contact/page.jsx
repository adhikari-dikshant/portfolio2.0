        ...
        <section className="contact screensaver-container" ref={containerRef}>
            <div className="contact-copy">
                <div className="contact-col">
                    <Copy delay={0.8} className="ml-5">
                        <h2>Let’s build what can’t be ignored.</h2>
                    </Copy>
                </div>
                ...
                <div className="contact-col">
                    <div className="contact-group">
                        <Copy delay={0.8}>
                            <p className="sm">I Craft</p>
                            <p>Interfaces That Feel Alive</p>
                            <p className="my-5">Design Systems With Spine</p>
                            <p>Motion That Means Something</p>
                        </Copy>
                    </div>

                    <div className="contact-group">
                        <Copy delay={1.2}>
                            <p className="sm">Operating From</p>
                            <p>Somewhere Between Logic & Madness</p>
                        </Copy>
                    </div>

                    <div className="contact-mail">
                        <Button delay={1.3} href="mailto:dikshantsadhikari03@gmail.com">
                            dikshantsadhikari03@gmail.com
                        </Button>
                    </div>

                    <div className="contact-group">
                        <Copy delay={1.4}>
                            <p className="sm">Currently</p>
                            <p>Available for Bold Ideas</p>
                            <p>Open to Freelance & Collabs</p>
                        </Copy>
                    </div>
                </div>
            </div>
            ...
            <div className="contact-footer">
                <div className="container">
                    <Copy delay={1.6} animateOnScroll={false}>
                        <p className="sm">Designed with Intent. Built with Obsession.</p>
                    </Copy>

                    <div className="contact-socials">
                        <Copy delay={1.7} animateOnScroll={false}>
                            <a className="sm" href="https://www.instagram.com/ikshwaku_/" target="_blank">
                                Instagram
                            </a>
                        </Copy>

                        <Copy delay={1.8} animateOnScroll={false}>
                            <a className="sm" href="https://www.linkedin.com/in/dikshant-singh-adhikari/" target="_blank">
                                LinkedIn
                            </a>
                        </Copy>

                        <Copy delay={1.9} animateOnScroll={false}>
                            <a className="sm" href="https://github.com/adhikari-dikshant" target="_blank">
                                GitHub
                            </a>
                        </Copy>
                    </div>
                    ...
                    <Copy delay={2} animateOnScroll={false}>
                        <p className="sm">&copy; <span className="date"></span>. No templates were harmed.</p>
                    </Copy>
                </div>
            </div>
        </section>
